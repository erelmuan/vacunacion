...
$Inicio=$Inicio +13;
$pdf->Text(17,$Inicio, "DNI ".$model->dni.", debe permanecer en aislamiento domiciliario");
$Inicio=$Inicio +13;
$pdf->Text(17,$Inicio, "y social preventivo por ser contacto estrecho de caso positivo");
$Inicio=$Inicio +13;
$pdf->Text(17,$Inicio, "Covid-19 desde la fecha del presente certificado, hasta el");
$Inicio=$Inicio +13;
$pdf->Text(17,$Inicio,utf8_decode("alta que será otorgada por el equipo de salud."));
$Inicio=$Inicio +110;
