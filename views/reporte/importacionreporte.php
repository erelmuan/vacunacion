...
<!--  -->
  ...
  <div class="row">
    ...
    <div class="outer-container">
        <form action="<?=Yii::$app->homeUrl."?r=reporte/importacionreporte"; ?>" method="post"
            name="frmExcelImport" id="frmExcelImport" enctype="multipart/form-data">
            <div>
                <label>Elija Archivo Excel</label>
                <input type="file"class="form-control"  name="file" id="file" accept=".xls,.xlsx">

                <button onclick="spinner()" type="submit" id="submit" name="import" class="btn btn-success">Importar Registros</button>
...
<div class="reporte-view">
  ...
  <?php echo Html::a('VACIAR', ['eliminar'], [
      ...
      'data' => [
          'confirm' => 'SE VACIARA TODO EL REPORTE',
          'method' => 'post',
      ],
  ]) ?>
